<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.name" @click="showDiscounts=true">
    ...
    <div class="activity-sheet" v-show="showDiscounts">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="discountsClasses[support.type]" v-for="(support,index) in info.supports" :key="index">
            <span class="content-tag">
...
export default {
  data() {
    return {
      showBulletin: false,//是否显示商家公告
      showDiscounts: false,//是否显示商家优惠活动
      discountsClasses:["activity-green", "activity-red", "activity-orange"]
    };
  },
  computed: {
    ...mapState({
