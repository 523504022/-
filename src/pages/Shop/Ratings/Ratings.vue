        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType === 0 ? 'icon-zan' : 'icon-chaping'"></span>
              </div>
...
export default {
  data() {
    return {
      selectType: 0, //0为好评 1为差评 2为全部
      onlyContent: true //是否显示有文本内容的评价
    }
  },
  mounted() {
  ...
  computed: {
    ...
    // 根据selectType，onlyContent 生成新的数组进行显示
    filterRatings() {
